...
potions_winter = ReportCycle.new(
  name: "Winter Term",
  start_date: "2018-01-08",
  end_date: "2018-03-19",
...
potions_spring = ReportCycle.new(
  name: "Spring Term",
...
potions_summer = ReportCycle.new(
  name: "Summer Term",
...
defense_winter = ReportCycle.new(
  name: "Winter Term",
  start_date: "2018-01-08",
  end_date: "2018-03-19",
...
defense_spring = ReportCycle.new(
  name: "Spring Term",
  start_date: "2018-03-20",
  end_date: "2018-06-20",
  teaching_set: defense5
...
defense_summer = ReportCycle.new(
  name: "Summer Term",
  start_date: "2018-06-21",
  end_date: "2018-09-22",
  teaching_set: defense5
...
lewagon_tuesday = Lesson.new(
  start_time: "2018-08-28 09:00",
  end_time: "2018-08-28 18:30",
  teaching_set: lewagon
  )
lewagon_tuesday.save

lewagon_wednesday = Lesson.new(
  start_time: "2018-08-29 09:00",
  end_time: "2018-08-29 18:30",
  teaching_set: lewagon
  )
lewagon_wednesday.save

lewagon_thursday = Lesson.new(
  start_time: "2018-08-30 09:00",
  end_time: "2018-08-30 18:30",
  teaching_set: lewagon
  )
lewagon_thursday.save

lewagon_friday = Lesson.new(
...
potions_tuesday = Lesson.new(
  start_time: "2018-08-28 10:00",
  end_time: "2018-08-28 11:30",
  teaching_set: potions5
  )
potions_tuesday.save

potions_friday = Lesson.new(
